...
for (filename in list.files("./data/commit_metadata/")) {
  if (project_count %% 50 == 0) {
    print(project_count)
  }
  meta <- read.csv(paste("./data/commit_metadata/", filename, sep = ""))
  file <- read.csv(paste("./data/commit_files/",filename, sep = ""))
